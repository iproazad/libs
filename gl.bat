...
adb shell rm -rf /sdcard/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Demos
adb shell rm -rf /sdcard/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/MoviesPakDir

:: مسح سجلات الانهيار (Anti-Report)
adb shell rm -rf /data/data/com.tencent.ig/app_crashrecord
adb shell rm -rf /data/data/com.tencent.ig/files/CrashSight
...
adb shell rm -f /data/data/com.tencent.ig/lib/libswappy.so

:: رفع الملفات المعدلة وإعطاؤها صلاحيات كاملة [cite: 14, 15]
adb push libgame.so /data/data/com.tencent.ig/lib/libgame.so
adb shell chmod 777 /data/data/com.tencent.ig/lib/libgame.so

adb push libswappy.so /data/data/com.tencent.ig/lib/libswappy.so
adb shell chmod 777 /data/data/com.tencent.ig/lib/libswappy.so
